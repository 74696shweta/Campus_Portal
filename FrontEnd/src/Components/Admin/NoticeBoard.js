...
export function NoticeBoard() {
  ...
  axios.defaults.withCredentials = true;  
    ...
    axios.defaults.withCredentials = true;
    const handleEdit = (el) => {    
        navigate('/admin/updatenotice/' + el._id , {state  : el})
    };
...
<button type="button" className="btn btn-primary btn-lg" style={{borderRadius: "5px",marginTop: "20px"}}><NavLink to="/admin/addnotice">Publish Notice</NavLink></button> <br /><br />
{data.map((e,i) => (
