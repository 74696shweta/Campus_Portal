  ...
  <div className="container h-100">
    <div className="row d-flex justify-content-center align-items-center h-100">
      <div className="col-xl-9">
       <input type="hidden" name='id' value={values.nid} onChange={handleForm} />
          ...
          <div className="card-body">
            ...
            <div className="row align-items-center py-3">
              ...
              <div className="col-md-9 pe-5">
                ...
                <input type="text" value={values.contact} onChange={handleForm} name="contact" className="form-control form-control-lg" placeholder="+91 - 98XXXXX" maxLength={10} required/>
            ...
            <div className="px-5 py-4 mb-4">
              <button type="submit" className="btn btn-primary btn-lg" onClick={handleSubmit}>Update Notice</button>
            </div>
