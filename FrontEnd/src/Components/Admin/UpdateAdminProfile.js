...
export function AdminProfileUpdate() {
...
const handleImages  =  (e) =>{
  ...
  return (
   ...
   <br /><br />
    ...
    <h3 style={{textAlign: "center",marginTop: "70px",marginLeft: "60px"}}>Update Profile</h3>
      ...
      <input type="hidden" name='id' value={values.sid} onChange={handleForm} />
        ...
        <div className="card" style={{borderRadius:"15px;"}}>
          ...
          <div className="form-group">
            <img src={values.image} width='150px' height='150px' style={{borderRadius: "100px",marginLeft: "300px"}}/>
        </div> 
        <hr className="mx-n3" /> 
         <div className="row align-items-center">
            ...
            <div className="px-5 py-4 mb-4">
              <button type="submit" style={{marginRight: "50px"}} className="btn btn-primary btn-lg" onClick={handleSubmit}>Update Profile</button>
              <NavLink to = "/admin/adminprofile" className="btn btn-primary btn-lg" >Back</NavLink>
            </div>
